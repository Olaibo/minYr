...
import (
	...
	"strconv"
	"strings"
	/*"github.com/Olaibo/funtemps/conv"*/
)
...
func Convert() error {
	...
	dataText := "Data er basert paa gyldig data (per 18.03.2023) (CC BY 4.0) fra Meteorologisk institutt (MET); endringen er gjort av Olai Bergh Oldeide,,,"
